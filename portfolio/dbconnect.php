<?php
    ...
    $server = "localhost"; // имя хоста, тк работаем на локальном сервере, то указываем localhost
    $username = "root"; // Имя пользователя БД
    $password = ""; // Пароль пользователя
    $database = "bd"; // Имя базы данных, которую создали
    ...
    $address_site = "http://localhost/IP_site";
